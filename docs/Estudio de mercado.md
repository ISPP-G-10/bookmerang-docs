...
- [2. Introducción y visión del producto](#2-introducción-y-visión-del-producto)
- [3. Análisis de mercado](#3-análisis-de-mercado)
  - [3.1 Segmentación de clientes](#31-segmentación-de-clientes)
  - [3.2 Análisis de la Competencia](#32-análisis-de-la-competencia)
- [4. Propuesta de valor](#4-propuesta-de-valor)
- [5. Estrategia de Go-to-Market (cómo llegar al cliente)](#5-estrategia-de-go-to-market-cómo-llegar-al-cliente)
  - [5.1 Canales de Adquisición (Fase 1 - MVP)](#51-canales-de-adquisición-fase-1---mvp)
...
## 2. Introducción y visión del producto
...
Nuestro público objetivo no se limita únicamente al lector ocasional. Hemos identificado tres segmentos clave basándonos en el comportamiento de usuario y tendencias actuales:

* El "Lector Social" (Gen Z y Millennial): Usuarios activos en plataformas como TikTok (\#BookTok), Fable o Instagram. Valoran la validación social, las reseñas y el sentido de pertenencia. Buscan compartir sus lecturas y proyectar su identidad literaria, lo que convierte a este perfil en el motor ideal para impulsar la vertical de 'red social' que define a Bookmerang  
* El Lector Económico: Sensible al precio. El coste medio de 15-25€ por libro nuevo es una barrera para este perfil. Buscan maximizar su acceso a la cultura con un presupuesto limitado.​  
* El Usuario Eco-friendly: Prioriza la sostenibilidad. Valoran la reducción de la huella de carbono y el desperdicio de papel inherente a la industria editorial tradicional.

### 3.2 Análisis de la Competencia

El mercado actual presenta soluciones fragmentadas. Bookmerang se posiciona en un "océano azul" al integrar funcionalidades que la competencia ofrece por separado:​

| Competidor | Enfoque Principal | Limitación Detectada | Ventaja Competitiva de Bookmerang |
| :---- | :---- | :---- | :---- |
| Fable | Red Social / Clubes de lectura. | Carece de mecanismos de intercambio físico de libros o economía circular. | Integración de la logística de intercambio con la “capa social”. |
...
* Frontend: React Native \+ TypeScript \+ Expo para una experiencia nativa fluida en iOS y Android, crítica para el uso de cámara (escaneo) y GPS.​  
* Backend: .NET \+ PostgreSQL \+ PostGIS para gestión eficiente de datos geoespaciales a gran escala, asegurando que el crecimiento de usuarios no degrade el rendimiento de las búsquedas por proximidad.​

Hitos clave:

* Q1: Lanzamiento MVP (Intercambio local \+ Chat).  
* Q2: Módulo Social completo (Stories \+ Feed) y Gamificación.  
* Q3: Versión Premium y expansión de radio geográfico.
